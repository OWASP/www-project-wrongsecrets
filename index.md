...
WrongSecrets is based on Java, Docker, Terraform, HCL and a bit of scripting fun. It contains more than 10 exercises with various "hidden" secrets which you need to find and enter.
